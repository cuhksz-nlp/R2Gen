...
class BaseDataset(Dataset):
    def __init__(self, args, tokenizer, split, transform=None):
        ...
        ##################################################################
        # trying out example annotated reports
        report = self.examples[0]['report']
        report = report.replace(report[:report.index(' ')], report[:report.index(' ')]
                                + " <ontology:" + report[:report.index(' ')] + ">", 1)
        self.examples[0]['report'] = report
