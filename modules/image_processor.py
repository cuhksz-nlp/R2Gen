...
def preprocess():
    ...
    root_folder = 'data/iu_xray/images'
    ...
    for subfolder in os.listdir(root_folder):
        ...
        for image_file in os.listdir(patient_folder_path):
            ...
            output_folder = 'data/standardized_iu_xray/images'
...
def image_preprocessor():
    os.mkdir('data/standardized_iu_xray')
    os.mkdir('data/standardized_iu_xray/images')
    shutil.copy('data/iu_xray/annotation.json', 'data/standardized_iu_xray/annotation.json')
    preprocess()
