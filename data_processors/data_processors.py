...
class DataProcessor(object):
    ...
    def get_reports_by_exp(self, exp, split, r2gen_id, report):
        if exp == 1:
            ...
            return report + self.iu_mesh_impression[split][r2gen_id]['impression']
        elif exp == 6:
            return report + self.iu_mesh_impression[split][r2gen_id]['impression'] + \
                   self.iu_mesh_impression[split][r2gen_id]['mesh']
        elif exp == 7:
            return report + self.iu_mesh_impression[split][r2gen_id]['impression'] + \
                   self.iu_mesh_impression[split][r2gen_id]['attr']
        elif exp == 8:
            return report + self.iu_mesh_impression[split][r2gen_id]['impression'] + \
                   self.iu_mesh_impression[split][r2gen_id]['mesh_attr']
    ############################################
